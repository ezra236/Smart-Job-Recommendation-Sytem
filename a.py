...
# Load the CSV file
df = pd.read_csv('new5.csv')  # Replace with your actual file path

# Remove currency symbols and commas, then convert 'Job Salary' to float32
df["Job Salary"] = df["Job Salary"].str.replace('$', '').str.replace(',', '').astype("float32")
