...
# Load the CSV file
df = pd.read_csv('combined_dataset.csv')  # Replace with your actual file path
...
# Save models in the correct directory
pickle.dump(rf_model, open(os.path.join(predictor_dir, "rf_model.pkl"), "wb"))
pickle.dump(vectorizer, open(os.path.join(predictor_dir, "tfidf_vectorizer.pkl"), "wb"))
pickle.dump(label_encoder, open(os.path.join(predictor_dir, "label_encoder.pkl"), "wb"))


training_columns = X.columns.tolist()
pickle.dump(training_columns, open(os.path.join(predictor_dir, "training_columns.pkl"), "wb"))